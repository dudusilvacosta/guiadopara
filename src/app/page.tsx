...
import { getTiposImagens } from "@/data/imagens";
import { Tipo } from "@/types/tipo";

export default function IndexPage() {
  const tipos: Tipo[] = getTiposImagens();
  ...
  function getImagemPorTipo(tipo: string): string {
    switch (tipo) {
      case "balnearios":
        return "https://upload.wikimedia.org/wikipedia/commons/thumb/2/27/Fonte_Azul_Itaituba_Par%C3%A1.jpg/500px-Fonte_Azul_Itaituba_Par%C3%A1.jpg?_=20180620161629";
